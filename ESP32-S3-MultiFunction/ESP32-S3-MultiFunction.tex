...
\begin{enumerate}
\item \textbf{Lamp Selection} This selects the lamp:
\begin{enumerate}
\item \textbf{Unused}
\item \textbf{A0}
\item \textbf{A1}
...
specified track speed for a given track circuit. The conditions supported are:

\begin{itemize}
\item \textbf{V1 AND V2} Both V1 and V2 must be true for this condition to be 
true.
\item \textbf{V1 OR V2} Either V1 or V2 must be true for this condition to be 
true.
\item \textbf{V1 XOR V2} Only one of V1 or V2 must be true for this condition 
to be true.
\item \textbf{V1 AND V2 $=>$ Change} Both V1 and V2 must be true and this must 
be a change for this condition to be true.
\item \textbf{V1 OR V2 $=>$ Change} Either V1 or V2 must be true and this must 
be a change for this condition to be true.
\item \textbf{V1 AND then V2 $=>$ true} If V1 is true and then V2 becomes true 
then this condition is true.
\item \textbf{V1 only} If V1 is true then this condition is true.
\item \textbf{V2 only} If V2 is true then this condition is true.
\item \textbf{null $=>$ true} The condition is always true.
\end{itemize}

\subsection{An Example}

A simple block signal displays \textbf{Stop} when the 
