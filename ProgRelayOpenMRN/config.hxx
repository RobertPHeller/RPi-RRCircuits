...
CDI_GROUP_ENTRY(relay,ConsumerConfig,Name("Relay"));
CDI_GROUP_ENTRY(blueleds,ConsumerConfig,Name("Blue LEDs"));
CDI_GROUP_ENTRY(progselect,ProducerConfig,Name("Program Track Enable"));
CDI_GROUP_END();
