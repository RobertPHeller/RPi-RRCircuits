#!/usr/bin/wish
# Generated code: Wed Nov 06 13:34:21 EST 2019
...
OpenLCB_Dispatcher ConnectToOpenLCB -transport OpenLCBOverTcp -port 12000 -nid 05:01:01:01:22:f0 -host localhost -name {QuadSMCSenseDispatch} -description {/home/heller/RRCircuits/QuadSMCSenseDispatch/QuadSMCSenseDispatch.tcl}
# OpenLCB_Dispatcher Nodes
# OpenLCB_Dispatcher BBB_1SW -eleclasstype SwitchPlate -normaleventid 05.01.01.01.22.51.00.00 -reverseeventid 05.01.01.01.22.51.00.01 -normalindonev 05.01.01.01.22.51.00.02 -normalindoffev 05.01.01.01.22.51.00.03 -reverseindonev 05.01.01.01.22.51.00.03 -reverseindoffev 05.01.01.01.22.51.00.02
OpenLCB_Dispatcher create %AUTO% -name BBB_1SW \
	-eleclasstype SwitchPlate \
	-normaleventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.51.00.00}] \
	-reverseeventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.51.00.01}] \
	-normalindonev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.51.00.02}] \
	-normalindoffev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.51.00.03}] \
	-reverseindonev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.51.00.03}] \
	-reverseindoffev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.51.00.02}]
# OpenLCB_Dispatcher RPI_1CD -eleclasstype CodeButton
OpenLCB_Dispatcher create %AUTO% -name RPI_1CD \
	-eleclasstype CodeButton \

# OpenLCB_Dispatcher RPI_1 -eleclasstype Switch -statenormaleventid 05.01.01.01.22.51.00.02 -statereverseeventid 05.01.01.01.22.51.00.03
OpenLCB_Dispatcher create %AUTO% -name RPI_1 \
	-eleclasstype Switch \
	-statenormaleventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.51.00.02}] \
	-statereverseeventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.51.00.03}]
...
# OpenLCB_Dispatcher RPI_1SW -eleclasstype SwitchPlate -normaleventid 05.01.01.01.22.52.00.00 -reverseeventid 05.01.01.01.22.52.00.01 -normalindonev 05.01.01.01.22.52.00.02 -normalindoffev 05.01.01.01.22.52.00.03 -reverseindonev 05.01.01.01.22.52.00.03 -reverseindoffev 05.01.01.01.22.52.00.02
OpenLCB_Dispatcher create %AUTO% -name RPI_1SW \
	-eleclasstype SwitchPlate \
	-normaleventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.52.00.00}] \
	-reverseeventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.52.00.01}] \
	-normalindonev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.52.00.02}] \
	-normalindoffev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.52.00.03}] \
	-reverseindonev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.52.00.03}] \
	-reverseindoffev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.52.00.02}]
...
# OpenLCB_Dispatcher PB_1 -eleclasstype Switch -statenormaleventid 05.01.01.01.22.50.00.02 -statereverseeventid 05.01.01.01.22.50.00.03
OpenLCB_Dispatcher create %AUTO% -name PB_1 \
	-eleclasstype Switch \
	-statenormaleventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.50.00.02}] \
	-statereverseeventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.50.00.03}]
# OpenLCB_Dispatcher PB_1SW -eleclasstype SwitchPlate -normaleventid 05.01.01.01.22.50.00.00 -reverseeventid 05.01.01.01.22.50.00.01 -normalindonev 05.01.01.01.22.50.00.02 -normalindoffev 05.01.01.01.22.50.00.03 -reverseindonev 05.01.01.01.22.50.00.03 -reverseindoffev 05.01.01.01.22.50.00.02
OpenLCB_Dispatcher create %AUTO% -name PB_1SW \
	-eleclasstype SwitchPlate \
	-normaleventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.50.00.00}] \
	-reverseeventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.50.00.01}] \
	-normalindonev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.50.00.02}] \
	-normalindoffev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.50.00.03}] \
	-reverseindonev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.50.00.03}] \
	-reverseindoffev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.50.00.02}]
# OpenLCB_Dispatcher BBB_1CD -eleclasstype CodeButton
OpenLCB_Dispatcher create %AUTO% -name BBB_1CD \
	-eleclasstype CodeButton \

# OpenLCB_Dispatcher BBB_1 -eleclasstype Switch -statenormaleventid 05.01.01.01.22.51.00.02 -statereverseeventid 05.01.01.01.22.51.00.03
