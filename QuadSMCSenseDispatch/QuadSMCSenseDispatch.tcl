#!/usr/bin/wish
# Generated code: Thu Jan 23 15:32:41 EST 2020
...
# -openlcbtransportopts {-port 12000 -nid 05:01:01:01:22:f0 -host charliebrown}
...
OpenLCB_Dispatcher ConnectToOpenLCB -transport OpenLCBOverTcp -port 12000 -nid 05:01:01:01:22:f0 -host charliebrown -name {QuadSMCSenseDispatch} -description {QuadSMCSenseDispatch.tcl}
# OpenLCB_Dispatcher Nodes
# OpenLCB_Dispatcher BBB_1SW -eleclasstype SwitchPlate -normaleventid 05.01.01.01.22.97.00.00 -reverseeventid 05.01.01.01.22.97.00.01 -normalindonev 05.01.01.01.22.97.00.08 -normalindoffev 05.01.01.01.22.97.00.09 -reverseindonev 05.01.01.01.22.97.00.09 -reverseindoffev 05.01.01.01.22.97.00.08
OpenLCB_Dispatcher create %AUTO% -name BBB_1SW \
	-eleclasstype SwitchPlate \
	-normaleventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.97.00.00}] \
	-reverseeventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.97.00.01}] \
	-normalindonev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.97.00.08}] \
	-normalindoffev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.97.00.09}] \
	-reverseindonev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.97.00.09}] \
	-reverseindoffev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.97.00.08}]
# OpenLCB_Dispatcher RPI_1CD -eleclasstype CodeButton
OpenLCB_Dispatcher create %AUTO% -name RPI_1CD \
	-eleclasstype CodeButton \

# OpenLCB_Dispatcher RPI_1 -eleclasstype Switch -statenormaleventid 05.01.01.01.22.98.00.08 -statereverseeventid 05.01.01.01.22.98.00.09
OpenLCB_Dispatcher create %AUTO% -name RPI_1 \
	-eleclasstype Switch \
	-statenormaleventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.98.00.08}] \
	-statereverseeventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.98.00.09}]
# OpenLCB_Dispatcher ESP32_1CD -eleclasstype CodeButton
OpenLCB_Dispatcher create %AUTO% -name ESP32_1CD \
	-eleclasstype CodeButton \

# OpenLCB_Dispatcher ESP32_1 -eleclasstype Switch -statenormaleventid 05.01.01.01.22.60.00.08 -statereverseeventid 05.01.01.01.22.60.00.09
OpenLCB_Dispatcher create %AUTO% -name ESP32_1 \
	-eleclasstype Switch \
	-statenormaleventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.60.00.08}] \
	-statereverseeventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.60.00.09}]
# OpenLCB_Dispatcher RPI_1SW -eleclasstype SwitchPlate -normaleventid 05.01.01.01.22.98.00.01 -reverseeventid 05.01.01.01.22.98.00.00 -normalindonev 05.01.01.01.22.98.00.08 -normalindoffev 05.01.01.01.22.98.00.09 -reverseindonev 05.01.01.01.22.98.00.09 -reverseindoffev 05.01.01.01.22.98.00.08
OpenLCB_Dispatcher create %AUTO% -name RPI_1SW \
	-eleclasstype SwitchPlate \
	-normaleventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.98.00.01}] \
	-reverseeventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.98.00.00}] \
	-normalindonev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.98.00.08}] \
	-normalindoffev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.98.00.09}] \
	-reverseindonev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.98.00.09}] \
	-reverseindoffev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.98.00.08}]
# OpenLCB_Dispatcher ESP32_1SW -eleclasstype SwitchPlate -normaleventid 05.01.01.01.22.60.00.00 -reverseeventid 05.01.01.01.22.60.00.01 -normalindonev 05.01.01.01.22.60.00.08 -normalindoffev 05.01.01.01.22.60.00.09 -reverseindonev 05.01.01.01.22.60.00.09 -reverseindoffev 05.01.01.01.22.60.00.08
OpenLCB_Dispatcher create %AUTO% -name ESP32_1SW \
	...
	-normalindonev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.60.00.08}] \
	-normalindoffev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.60.00.09}] \
	-reverseindonev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.60.00.09}] \
	-reverseindoffev [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.60.00.08}]
...
# OpenLCB_Dispatcher BBB_1 -eleclasstype Switch -statenormaleventid 05.01.01.01.22.97.00.08 -statereverseeventid 05.01.01.01.22.97.00.09
OpenLCB_Dispatcher create %AUTO% -name BBB_1 \
	-eleclasstype Switch \
	-statenormaleventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.97.00.08}] \
	-statereverseeventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.97.00.09}]
