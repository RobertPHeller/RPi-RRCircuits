...
using AllConsumers = RepeatedGroup<ConsumerConfig, NUMOUTS>;
using AllProducers = RepeatedGroup<ProducerConfig, NUMINS>;
...
CDI_GROUP_ENTRY(outputs,AllConsumers,Name("Inputs"),RepName("Input"))
CDI_GROUP_ENTRY(inputs,AllProducers,Name("Outputs"),RepName("Output"))
CDI_GROUP_END();
