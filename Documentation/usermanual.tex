...
\includeonly{SMCSenseHAT,QuadSSSQuadIn,MCP23017,OctalLEDDriver,QuadSMCSenseHat}
\begin{document}
...
\include{CANHat2}
\include{ButtonHat}
\include{LEDDriverHat}
\include{QuadSignalDriverCK}
\include{QuadSignalDriverCA}
\include{SignalHAT}
