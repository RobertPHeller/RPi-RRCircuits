...
namespace eval configurednoproducer {
    snit::type ConfiguredNoProducer {
        ...
        constructor {args} {
            ...
            ::log::log debug "$type create $self: -waitcount is [$self cget -waitcount]"
        }
    }
}
            
package provide ConfiguredNoProducer 1.0
