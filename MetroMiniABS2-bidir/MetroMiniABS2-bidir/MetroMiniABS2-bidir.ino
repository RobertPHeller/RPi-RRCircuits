 ...
 *
 * Consumed:
 *   Next Block East Occupied
 *   Next Block East Clear
 *   Next Block West Occupied
 *   Next Block West Clear
 * Produced:
 *   Block Occupied
 *   Block Clear
 *   East Stop Aspect Triggered
 *   East Stop Aspect Released
 *   East Approach Aspect Triggered
 *   East Approach Aspect Released
 *   East Clear Aspect Triggered
 *   East Clear Aspect Released
 *   West Stop Aspect Triggered
 *   West Stop Aspect Released
 *   West Approach Aspect Triggered
 *   West Approach Aspect Released
 *   West Clear Aspect Triggered
 *   West Clear Aspect Released
 *
...
#define ESIGNALGREEN 0 // No button 
#define ESIGNALYELLOW 1 // No button
#define ESIGNALRED 2 // No button
#define WSIGNALGREEN 3 // No button 
#define WSIGNALYELLOW 4 // No button
#define WSIGNALRED 5 // No button

TLC59208F tlc59208f;


ButtonLed_noled blockocc(BLOCKOCC,LOW); // No LED (sense only)
ButtonLed_nc nextblockE(0); // No actual pin (state set by event)
ButtonLed_nc nextblockW(0); // No actual pin (state set by event)
ButtonLed_nobutton signalgreenE(ESIGNALGREEN,&tlc59208f); // No button, LED only
ButtonLed_nobutton signalyellowE(ESIGNALYELLOW,&tlc59208f); // No button, LED only
ButtonLed_nobutton signalredE(ESIGNALRED,&tlc59208f); // No button, LED only
ButtonLed_nobutton signalgreenW(WSIGNALGREEN,&tlc59208f); // No button, LED only
ButtonLed_nobutton signalyellowW(WSIGNALYELLOW,&tlc59208f); // No button, LED only
ButtonLed_nobutton signalredW(WSIGNALRED,&tlc59208f); // No button, LED only
...
Mast mastE(&blockocc,&nextblockE,
          &signalgreenE,&signalyellowE,&signalredE,
          &(configOptions.signalOptions));
Mast mastW(&blockocc,&nextblockW,
          &signalgreenW,&signalyellowW,&signalredW,
          &(configOptions.signalOptions));
...
extern "C" {
 const char configDefInfo[] PROGMEM = {
   ...
   105, 46, 120, 115, 100, 39, 62, 10, 10, 32, 32, 60, 105, 100, 101, 110, 116, 105, 102, 105, 99, 97, 116, 105, 111, 110, 62, 10, 32, 32, 32, 32, 60, 109, 97, 110, 117, 102, 97, 99, 116, 117, 114, 101, 114, 62, 68, 101, 101, 112, 119, 111, 111, 100, 115, 32, 83, 111, 102, 116, 119, 97, 114, 101, 60, 47, 109, 97, 110, 117, 102, 97, 99, 116, 117, 114, 101, 114, 62, 10, 32, 32, 32, 32, 60, 109, 111, 100, 101, 108, 62, 77, 101, 116, 114, 111, 77, 105, 110, 105, 65, 66, 83, 45, 98, 105, 100, 105, 114, 60, 47, 109, 111, 100, 101, 108, 62, 10, 32, 32, 32, 32, 60, 104, 97, 114, 100, 119,    // | i.xsd'>  <identification>    <manufacturer>Deepwoods Software</manufacturer>    <model>MetroMiniABS-bidir</model>    <hardw|
   60, 110, 97, 109, 101, 62, 87, 101, 115, 116, 32, 67, 108, 101, 97, 114, 32, 65, 115, 112, 101, 99, 116, 32, 84, 114, 105, 103, 103, 101, 114, 101, 100, 60, 47, 110, 97, 109, 101, 62, 10, 32, 32, 32, 32, 32, 32, 60, 47, 101, 118, 101, 110, 116, 105, 100, 62, 10, 32, 32, 32, 32, 32, 32, 60, 101, 118, 101, 110, 116, 105, 100, 62, 10, 32, 32, 32, 32, 32, 32, 32, 32, 60, 110, 97, 109, 101, 62, 87, 101, 115, 116, 32, 67, 108, 101, 97, 114, 32, 65, 115, 112, 101, 99, 116, 32, 82, 101, 108, 101, 97, 115, 101, 100, 60, 47, 110, 97, 109, 101, 62, 10, 32, 32, 32, 32, 32, 32,    // | <name>West Clear Aspect Triggered</name>      </eventid>      <eventid>        <name>West Clear Aspect Released</name>      |
   60, 47, 101, 118, 101, 110, 116, 105, 100, 62, 10, 32, 32, 32, 32, 60, 47, 103, 114, 111, 117, 112, 62, 10, 32, 32, 60, 47, 115, 101, 103, 109, 101, 110, 116, 62, 10, 60, 47, 99, 100, 105, 62, 10,    // | </eventid>    </group>  </segment></cdi>|
   0
 };

 const char SNII_const_data[] PROGMEM = "\001MetroMiniABS-bidir\000Metro Mini Automatic Block Signal Bi Directional\0001.0\000" OlcbCommonVersion ; // last zero in double-quote
...
// The patterns are only used with the Blue and Gold ButtonLeds.
long patterns[] = {
...
// Non of these are actual buttons with LEDs.  One input, two state, and six 
// PWM outputs.
ButtonLed* buttons[] = {
    &nextblockE,&nextblockE,
    &nextblockW,&nextblockW,
    &blockocc,&blockocc,
    &signalredE,&signalredE,
    &signalyellowE,&signalyellowE,
    &signalgreenE,&signalgreenE,
    &signalredW,&signalredW,
    &signalyellowW,&signalyellowW,
    &signalgreenW,&signalgreenW
};
...
void pceCallback(int index){
    ...
    // Process mast...
    if (index == 0 || index == 1) mastE.eval();
    if (index == 2 || index == 3) mastW.eval();
}
...
bool states[] = {false, false, false, false, false, false, false, false, false}; // current input states; report when changed
...
#define LAST_PRODUCER_CHANNEL_INDEX     8
...
void setup()
{
  ...
  tlc59208f.begin();
  // Set up LED Driver state control
  tlc59208f.led_driver_state_control(ESIGNALGREEN,false,false,true,false);
  tlc59208f.led_driver_state_control(ESIGNALYELLOW,false,false,true,false);
  tlc59208f.led_driver_state_control(ESIGNALRED,false,false,true,false);
  tlc59208f.led_driver_state_control(WSIGNALGREEN,false,false,true,false);
  tlc59208f.led_driver_state_control(WSIGNALYELLOW,false,false,true,false);
  tlc59208f.led_driver_state_control(WSIGNALRED,false,false,true,false);
  tlc59208f.led_driver_state_control(6,false,true,false,false);
  tlc59208f.led_driver_state_control(7,false,true,false,false);
